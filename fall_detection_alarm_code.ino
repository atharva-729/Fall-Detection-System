...
const char *authToken = "Your Authorization Token";
const char *accountSID = "Your account SID";

const char *twilioPhoneNumber = "Your twilio Generated Phone number";
const char *recipient = "Recipient Phone number"; // Make sure it's verified
...
void loop()
{
  ...
  if (mag > 2)
  {
    ...
    digitalWrite(D3, LOW);
    if (flag)
      sendSMS(recipient, "Fall detected!");
  }
...
void sendSMS(const char *recipient, const char *message)
{
  ...
  //======================================Edit this Part here==========================================
  String url = "https://api.twilio.com/2010-04-01/Accounts/Account SID here/Messages.json";
